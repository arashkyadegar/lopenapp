...
export default function IndexComponent({ props }: any) {
  ...
  return (
    <>
      ...
      {/* most new products */}
      <div className="p-4 mx-4 bg-white  rounded-xl mb-4 ">
      <div className="flex flex-row mb-4 px-2 py-1 border-[#EF5621] justify-center font-bold">
          <div className="">
            <a>تازه ترین ها</a>
          </div>
        </div>
      ...
      <div className="p-4 mx-4  bg-white  my-4 rounded-xl">
        <div className="flex flex-row mb-4 px-2 py-1 border-[#EF5621] justify-center font-bold">
          <div>
            <a>محبوب ترین ها</a>
          </div>
