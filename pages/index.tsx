...
export default function Home() {
  return (
    <>
      <div className="sm:grid-cols-3 grid grid-cols-1 p-5 gap-6">
        {/* swiper-top */}
        ...
        <div className="flex flex-row justify-center sm:flex-col   my-auto w-full gap-4 h-fit ">
          {/* free delivery */}
          <div className=" bg-white flex flex-col sm:flex-row   justify-center sm:justify-end  shadow-md shadow-gray-500  p-4  items-center">
            <a>ارسال رایگان</a>
            <svg
