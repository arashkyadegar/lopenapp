    ...
    <>
      <div className="sm:grid-cols-4 grid grid-cols-1 p-5 gap-6 group">
        ...
        <div className="w-full order-1 sm:order-2 col-span-3 relative ">
          ...
          >
            <SwiperSlide>
              <img className=" aspect-auto" src="slider (5).jpg"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img className="w-full  aspect-auto" src="slider (6).jpg"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img className="w-full   aspect-auto" src="slider (7).jpg"></img>
            </SwiperSlide>
          </Swiper>
        </div>
      </div>
      ...
      <div className="p-4 mx-4 bg-white    shadow-md shadow-gray-300 my-4 ">
        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 justify-center grid-rows-1 gap-4">
          {/* single product card */}
          <div className="text-right relative text-sm w-full max-w-sm bg-white    border border-[#FBF6EE] hover:border-[#FFB534] transition duration-200 shadow dark:bg-gray-800 dark:border-gray-700">
            <span className="flex font-bold bg-red-600  items-center w-16 h-6 justify-center text-center text-xs absolute text-white">
              <a>15%</a>
            </span>
            <div className="flex mb-2 overflow-hidden mt-6 justify-center">
              <div>
                <a href="#" className=" w-full h-full">
                  <img
                    className="hover:scale-110 w-40 aspect-auto transition duration-500 cursor-pointer"
                    src="images1.jpg"
                    alt="product image"
                  />
                </a>
