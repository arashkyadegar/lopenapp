                    ...
                    <div className="flex flex-col gap-2 mb-2">
                      ...
                      <div className="flex flex-col  border-b pb-4 border-gray-300 gap-4  w-full justify-between  ">
                        ...
                        <div className=" flex flex-row gap-2 items-center">
                          ...
                          <div className=" flex flex-row w-3/4 items-center justify-center bg-slate-300 px-3 py-2  cursor-pointer hover:text-white  hover:bg-[#80BB01] transition-all duration-300">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 24 24"
